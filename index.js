...
var ASM_CONSTS = {
  90142: () => { if (document.fullscreenElement) return 1; },  
 90188: () => { return Module.canvas.width; },  
 90220: () => { return parseInt(Module.canvas.style.width); },  
 90268: () => { document.exitFullscreen(); },  
 90295: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90367: () => { if (document.fullscreenElement) return 1; },  
 90413: () => { return Module.canvas.width; },  
 90445: () => { return screen.width; },  
 90470: () => { document.exitFullscreen(); },  
 90497: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90691: () => { return window.innerWidth; },  
 90717: () => { return window.innerHeight; },  
 90744: () => { if (document.fullscreenElement) return 1; },  
 90790: () => { return Module.canvas.width; },  
 90822: () => { return parseInt(Module.canvas.style.width); },  
 90870: () => { if (document.fullscreenElement) return 1; },  
 90916: () => { return Module.canvas.width; },  
 90948: () => { return screen.width; },  
 90973: () => { return window.innerWidth; },  
 90999: () => { return window.innerHeight; },  
 91026: () => { if (document.fullscreenElement) return 1; },  
 91072: () => { return Module.canvas.width; },  
 91104: () => { return screen.width; },  
 91129: () => { document.exitFullscreen(); },  
 91156: () => { if (document.fullscreenElement) return 1; },  
 91202: () => { return Module.canvas.width; },  
 91234: () => { return parseInt(Module.canvas.style.width); },  
 91282: () => { document.exitFullscreen(); },  
 91309: ($0) => { Module.canvas.style.opacity = $0; },  
 91347: () => { return screen.width; },  
 91372: () => { return screen.height; },  
 91398: () => { return window.screenX; },  
 91425: () => { return window.screenY; },  
 91452: () => { return window.devicePixelRatio; },  
 91488: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91541: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91592: () => { Module.canvas.style.cursor = 'none'; },  
 91629: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91885: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91936: () => { if (document.pointerLockElement) return 1; },  
 91983: () => { if (document.fullscreenElement) return 1; },  
 92029: () => { return window.innerWidth; },  
 92055: () => { return window.innerHeight; }
};
